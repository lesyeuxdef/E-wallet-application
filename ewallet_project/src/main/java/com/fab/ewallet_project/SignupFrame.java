...
public class SignupFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        filler8 = new javax.swing.Box.Filler(new java.awt.Dimension(0, 0), new java.awt.Dimension(0, 60), new java.awt.Dimension(0, 20));
        ...
        jLabel2.setPreferredSize(new java.awt.Dimension(143, 80));
        signupPanel.add(jLabel2, java.awt.BorderLayout.PAGE_START);
    ...
    /*
    paybuddy makeAccount()
    {
        paybuddy userAccount;
        signupButton.addActionListener((ActionEvent e) ->  
        {
        javax.swing.JOptionPane.showMessageDialog(null,"Signed up!","",javax.swing.JOptionPane.INFORMATION_MESSAGE);
        userAccount = new paybuddy(usernameField.getText(),emailField.getText(),numberField.getText(),passwordField.getText());  
