            ...
            signupButton.addActionListener(e ->
                {
                    ...
                    paybuddy paybuddyObj = new paybuddy(usernameField.getText(),emailField.getText(),numberField.getText(),passwordField.getText());
                });
...
class paybuddy implements e_walletFunctions
{
    ...
    paybuddy(String accountName, String email, String number, String psasword)
    {
